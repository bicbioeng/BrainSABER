...
<<<<<<< HEAD
the BrainSpan atlas through an R Shiny interface. BrainSABER extends the 
SummarizedExperiment class into a self-validating container for user data
=======
...
=======
The BrainSABER workflow can be used to compare the Allen Institute data to a Biobase ExpressionSet.  
